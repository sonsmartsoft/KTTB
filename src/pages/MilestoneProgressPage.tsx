            ...
            <table className="w-full text-xs">
              <thead>
                <tr className="bg-app-subtle border-b border-app-border">
                  <th className="text-left px-4 py-2.5 font-bold text-content-muted">Kỳ thi / Cột mốc</th>
                  ...
                  return (
                    <tr key={m.id} className="hover:bg-primary/[0.03] transition-colors group">
                      <td className="px-4 py-3">
                        <div className="font-semibold text-content-primary leading-snug">{m.title}</div>
                        {m.preparation_notes && (
