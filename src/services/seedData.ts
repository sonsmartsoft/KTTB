...
export const SEED_EXAM_PREP_TASKS: ExamPrepTask[] = [
  {
    id: 'prep-sep-1',
    milestone_id: 'milestone-survey-sep',
    child_id: 'child-trung-quan',
    title: 'Ôn tập Đại số: Tập hợp, phần tử và các phép toán số tự nhiên',
    subject: 'Toán bồi dưỡng',
    due_date: '2026-09-24',
    priority: 'high',
    is_completed: true,
    notes: 'Làm lại các bài nâng cao trong phiếu bài tập thầy giao.',
  ...
  },
  {
    ...
    milestone_id: 'milestone-survey-sep',
    child_id: 'child-trung-quan',
    title: 'Học thuộc và ứng dụng 40 từ vựng Unit 1 (Friends Plus 6)',
    subject: 'Tiếng Anh',
    due_date: '2026-09-25',
    priority: 'high',
    is_completed: true,
    notes: 'Kiểm tra phát âm và thì hiện tại đơn / hiện tại tiếp diễn.',
  ...
  },
  {
    ...
    milestone_id: 'milestone-survey-sep',
    child_id: 'child-trung-quan',
    title: 'Luyện 2 đề thi thử khảo sát Toán Tháng 9 (thời gian 45 phút)',
    subject: 'Toán bồi dưỡng',
    due_date: '2026-09-25',
    priority: 'high',
    is_completed: false,
    notes: 'Bấm giờ chuẩn như thi thật, chú ý bài toán tìm x và lũy thừa.',
    created_at: '2026-09-20',
  },
  {
    id: 'prep-mid-1',
    milestone_id: 'milestone-midterm-1',
    child_id: 'child-trung-quan',
    title: 'Tổng hợp sơ đồ tư duy môn Khoa học Tự nhiên 6 (Phần Vật sống)',
    subject: 'KHTN',
    due_date: '2026-10-25',
    priority: 'medium',
    is_completed: false,
    notes: 'Vẽ sơ đồ cấu tạo tế bào và các cơ quan quang hợp.',
  ...
  },
  {
    ...
    milestone_id: 'milestone-midterm-1',
    child_id: 'child-trung-quan',
    title: 'Luyện viết đoạn văn cảm thụ văn học (Bài thơ Lượm / Đồng dao mùa xuân)',
    subject: 'Ngữ văn',
    due_date: '2026-10-28',
    priority: 'high',
    is_completed: false,
    notes: 'Chú ý cách mở đoạn trực tiếp và liên hệ cảm xúc bản thân.',
    created_at: '2026-09-21',
  },
  {
    id: 'prep-mid-3',
    milestone_id: 'milestone-midterm-1',
    child_id: 'child-trung-quan',
    title: 'Giải trọn bộ đề cương ôn thi Giữa HK1 môn Toán',
    subject: 'Toán',
    due_date: '2026-11-02',
    priority: 'high',
    is_completed: false,
    notes: 'Chia làm 3 buổi: Số học, Hình học trực quan (tam giác đều, lục giác đều).',
    created_at: '2026-09-21',
  },
];
